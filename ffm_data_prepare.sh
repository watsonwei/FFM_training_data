...
push_event_hdfs="hdfs://dc2/user/mrd/push/event/"${two_hours_ago}"/*"
push_event_hdfs_flag="hdfs://dc2/user/mrd/push/event/"${two_hours_ago}"/_SUCCESS"
...
for i in $(seq 1 14);
do
    news_hdfs_one_day="hdfs://dc2/user/mrd/hive/warehouse/news_pool/t_news_index/hour=$(date -d $i' days ago' +'%Y%m%d')*/*"
